...
std::string	msg307(Client *client, std::string target);
std::string	msg311(Client *client, Client *target);
std::string	msg312(Client *client, std::string target);
std::string	msg315(Client *client, std::string target);
std::string	msg319(Client *client, std::string target);
...
std::string	msgping(Client *client);
std::string	msgpong(Client *client, std::string pingValue);
